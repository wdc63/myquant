      ...
      <div class="snapshots-container">
        <div class="section">
          <div class="section-title-container">
            ...
            <button class="copy-btn" @click="copyToClipboard(snapshots.code, '策略代码')">
        ...
        <div class="section">
          <div class="section-title-container">
            ...
            <button class="copy-btn" @click="copyToClipboard(snapshots.config, '配置文件')">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
                <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
              </svg>
        ...
        <div class="section">
          <div class="section-title-container">
            ...
            <button class="copy-btn" @click="copyToClipboard(snapshots.data_provider, '数据提供者')">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
                <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
              </svg>
